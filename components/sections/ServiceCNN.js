					...
					<div className="row">
									...
									<div className="service-sidebar wow fadeInUp"
										...
										<ul>
											{serviceListData.map((eachitem, index) => (
												<li key={index}><Link className={(index === 1) ? 'current': ''} href={eachitem.linkurl}><i className="fas fa-angle-right"></i><span>{eachitem.title}</span></Link></li>
											))}
										</ul>
										</div>
									</div>
						...
						<div className="col-xl-8 col-lg-8">
							<div className="services-details__content">
								<img src="/images/resource/serviceCNN.jpg" title='Oitech' />
