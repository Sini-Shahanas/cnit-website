            ...
            <section className="industries-section">
                <div className="auto-container">
                    <div className="row">
                        ...
                        <div className="image-column col-lg-6 col-md-12 col-sm-12">
                            <div className="image-box wow fadeIn">
                                <figure className="image"><img src="/images/resource/colegues.jpg" title='Oitech' /></figure>
                            </div>
                        </div>
                    </div>
                    <div className="row justify-content-center">
                        ...
                        {/* Feature Block Two */}
                        <div className="feature-block-two col-xl-2 col-lg-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="200ms">
                            <div className="inner-box ">
                        ...
                        {/* Feature Block Two */}
                        <div className="feature-block-two col-xl-2 col-lg-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="400ms">
                            <div className="inner-box ">
                        ...
                        {/* Feature Block Two */}
                        <div className="feature-block-two col-xl-2 col-lg-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="600ms">
                            <div className="inner-box ">
                        ...
                        {/* Feature Block Two */}
                        <div className="feature-block-two col-xl-2 col-lg-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="800ms">
                            <div className="inner-box ">
                        ...
                        {/* Feature Block Two */}
                        <div className="feature-block-two col-xl-2 col-lg-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="1000ms">
                            <div className="inner-box ">
